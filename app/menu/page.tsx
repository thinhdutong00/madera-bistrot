...
export default function BarCaffetteria() {
  return (
    <section id="colazione" className="pt-32 pb-20 px-6 w-full bg-white">
      {/* Container per il titolo con margine superiore maggiorato */}
      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-stretch">
        ...
        <div className="flex flex-col justify-between">
          <div className="space-y-12 h-full flex flex-col">
            ...
            {/* Lista Salati posizionata in fondo per pareggiare la colonna sinistra */}
            <div className="space-y-1 pl-4 border-l-2 border-[#642d3a]/20 mt-auto">
