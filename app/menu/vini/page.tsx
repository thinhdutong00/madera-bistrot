      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-stretch">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="mb-12 lg:mb-16">
            ...
            {/* Immagine SOLO Mobile dopo Bollicine */}
            <div className="mt-8 lg:hidden relative h-[250px] rounded-2xl overflow-hidden shadow-lg">
          ...
          <div className="lg:mb-0">
            ...
            {/* Immagine SOLO Mobile dopo Bianchi */}
            <div className="mt-8 lg:hidden relative h-[250px] rounded-2xl overflow-hidden shadow-lg">
        ...
        {/* COLONNA DESTRA: ROSSI & IMMAGINE DESKTOP */}
        <div className="flex flex-col h-full">
          {/* Immagine Desktop (nascosta su mobile perché la mettiamo dopo i rossi) */}
          ...
          <div className="mt-auto">
            ...
            {/* Immagine Mobile dopo i Rossi (come richiesto) */}
            <div className="mt-8 lg:hidden relative h-[250px] rounded-2xl overflow-hidden shadow-lg">
