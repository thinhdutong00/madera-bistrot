    ...
    <footer className="w-full">
      ...
      <div className="bg-[#642d3a] text-[#ffefcc] py-12 px-6">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-4">
          ...
          {/* 1. Orari - Larghezza minima per evitare che spinga troppo gli altri */}
          ...
          {/* 2. Contatti & Dove Siamo - Raggruppati vicini */}
          ...
          {/* 3. Immagine - Dimensioni controllate per riempire il centro senza vuoti */}
          ...
          {/* 4. Branding - Allineato a destra e compatto */}
          <div className="text-center lg:text-right min-w-fit">
